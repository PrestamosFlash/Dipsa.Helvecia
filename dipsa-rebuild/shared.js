(function(){
  ...
  function normalizeBusiness(business){
    ...
    const merged = Object.assign(base, business || {}, {
    ...
    delete merged.birthdayBannerText;
    return merged;
  }
  ...
  function normalizeStorefront(raw){
    ...
    return {
      ...
      birthdayPeopleToday: Array.isArray(source.birthdayPeopleToday)
        ? source.birthdayPeopleToday.filter(Boolean)
        : (Array.isArray(source.birthday_people_today) ? source.birthday_people_today.filter(Boolean) : [])
    };
  }
